...
`notebooks/comparisons/spiderboost-vs-dp-sgd-on-criteo.ipynb`, and
`notebooks/comparisons/what-the-categorical-encoding-costs.ipynb` (through
`forward_sparse` on its one-hot arm).
